...
int main(int argc, char * argv[]) {
	...
	if (pid > 0) {
        ...
        // DEBUG
        // Test Bounded Buffer
    	//BoundedBuffer request_buffer(3);
        
        //request_buffer.retrieve_front();
        
        //request_buffer.push_back("1");
        //request_buffer.push_back("2");
        //request_buffer.push_back("3");
        
        //while(request_buffer.size()>0){
        //    std::string s = request_buffer.retrieve_front();
        //    printf("%s\n",s.c_str());
        //}
